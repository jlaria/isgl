# Script to run iSgL with the simulations from Feng and Simon [2017]
 setwd('/home/juank/Documents/Doctorado/Investigacion/uranus.uc3m.es/PBS/matrix4200-RS/runs/num_groups2/')
 expert_num_groups = 200
 pj = 21
 num_groups = 2
 # Run python code...
 system('~/miniconda2/bin/python ../../base/python/main.py 90 60 4200 200 2 30') 
 results.table = NULL 
 for (i in 1:30){
